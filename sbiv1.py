...
from keras.layers import LSTM, Dense, Dropout, Input, Attention, Concatenate
...
def train_and_predict(sequence_length=60, epochs=100, batch_size=128, units=50, dropout_rate=0.2, threshold_mae=1.0):
    ...
    last_sequence = np.hstack([scaled_close_prices[-sequence_length:], scaled_volumes[-sequence_length:]])
